...
Module folder related to Categorical Features.

## Files

- `beijing_categorical_features.ipynb` — Encodes categorical variables and evaluates their impact on model performance.
